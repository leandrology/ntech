...
const CTA3 = () => {
  return (
    <div>
      <section class="relative z-10 overflow-hidden bg-indigo-600 py-16 px-8 mt-40">
        <div class="container">
          <div class="mx-[200px] flex flex-wrap items-center">
            ...
            <div class="w-full px-4 lg:w-1/2">
              <div class="text-center lg:text-right">
                <a
                  class="text-center focus-visible:outline-black lg:w-auto focus-visible:ring-black hover:bg-rose-100 hover:text-rose-500 text-white font-semibold rounded-lg mx-auto inline-flex items-center justify-center bg-white py-4 px-9 hover:bg-opacity-90"
                  href="#"
                >
                  Contact Us &nbsp;&nbsp;
